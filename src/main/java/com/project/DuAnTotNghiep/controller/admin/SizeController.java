...
public class SizeController {
    ...
    public String addSize(Model model, @Validated @ModelAttribute("Size") Size size, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage", "Thêm Bảo hành mới thành công");
        }
        catch (Exception e) {
    ...
    public String update(@PathVariable("id") Long id,
        ...
        if (optional.isPresent()) {
            try {
                ...
                redirectAttributes.addFlashAttribute("successMessage", "Bảo hành được cập nhật thành công");
    ...
    public String delete(@PathVariable("id") Long id, Model model){
        ...
        model.addAttribute("successMessage", "Xóa Bảo hành thành công");
        return "redirect:/admin/size-all";
    }
}
